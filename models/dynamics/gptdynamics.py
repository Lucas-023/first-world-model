...
class WorldModelConfig:
    def __init__(
        ...
        self.vocab_reward = 21
        self.vocab_done = 2
        self.vocab_action = 11 * 3  # 3 dimensões discretizadas
        ...
        # --- estrutura ---
        self.tokens_per_frame = tokens_per_frame + 3 + 2  # z + a + r + d = 64 + 3 + 1 + 1 = 69
...
class WorldModel(nn.Module):
    ...
    def forward(self, idx, targets=None):
        ...
        x = self.transformer.drop(tok_emb + self.transformer.pos_emb(pos))
